...
const wikiTabsConfig = (projectId: number) => [
  { key: "daily", label: "Project Daily Progress", match: "/project-daily-progress", href: `/projects/${projectId}/project-daily-progress`, Icon: Calendar },
  { key: "resource", label: "Resource Plan", match: "/resource-plan", href: `/projects/${projectId}/resource-plan`, Icon: UserCheck },
  { key: "risk", label: "Risk Register", match: "/risk-register", href: `/projects/${projectId}/risk-register`, Icon: AlertTriangle },
  { key: "lesson", label: "Lesson Learnt Register", match: "/lesson-learnt-register", href: `/projects/${projectId}/lesson-learnt-register`, Icon: Lightbulb },
  { key: "direct", label: "Direct Manpower List", match: "/direct-manpower-list", href: `/projects/${projectId}/direct-manpower-list`, Icon: User },
  { key: "indirect", label: "Indirect Manpower List", match: "/indirect-manpower-list", href: `/projects/${projectId}/indirect-manpower-list`, Icon: UserPlus },
  { key: "planned", label: "Planned Activity / Tasks", match: "/planned-activity-tasks", href: `/projects/${projectId}/planned-activity-tasks`, Icon: ListTodo },
  { key: "others", label: "Other Wiki", match: "/project-docs/OtherWiki", href: `/projects/${projectId}/project-docs/OtherWiki`, Icon: BookOpen },
];
