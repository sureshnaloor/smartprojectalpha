...
export default function ServiceMasterType() {
  ...
  const createMutation = useMutation({
    ...
    onError: () => toast({ title: "Error creating Service Type", variant: "destructive" }),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: () => toast({ title: "Error updating Service Type", variant: "destructive" }),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => toast({ title: "Error deleting Service Type", variant: "destructive" }),
  });
